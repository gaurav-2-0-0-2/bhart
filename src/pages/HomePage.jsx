...
export default function HomePage() { 
  return (
    <div className="flex flex-col gap-6 max-w-screen-xl m-auto">
     ...
     <h1 className="mt-[1rem] text-center text-4xl md:text-6xl mx-auto font-bold">A Repo Of Folk Indian Arts</h1>
      <p className="text-md md:text-3xl mt-[2rem] text-justify" >
